    ...
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="nav-container">
            ...
            <div class="navbar-header page-scroll">
               ...
               <a class="navbar-brand page-scroll" href="index.php"><img src="http://262fdo1ay0gn2mr7xv1y7xfv.wpengine.netdna-cdn.com/wp-content/themes/orourke-twig/assets/images/orourke-logo-white.svg"></a>
            </div>
    ...
    <div class="form-area">  
        <form role="form" method="post" action="contact.php">
            ...
            <div class="form-row">
              ...
              <div class="form-group">
                <input type="text" class="form-control" id="email" name="email" placeholder="Where can I email you?" required>
              </div>
    ...
    <div class="form-area">  
        <form role="form" method="post" action="contact.php">
            ...
            <div class="form-row"> 
                ...
                <input type="text" class="form-control box-size" id="name" name="name" placeholder="What's your email address?" required>


                <input type="text" class="form-control" id="email" name="email" placeholder="What's your phone number?" required>
        ...
        <input type="hidden" name="deliverables" value="">
            ...
            <!-- Form Row End -->
                    <div class="form-group">
                    <textarea class="form-control lg-box" type="textarea" id="message" placeholder="Any additional or relevant information about this project?" maxlength="140" rows="10"></textarea>
                        <span class="help-block"><p id="characterLeft" class="help-block ">What's on your mind?</p></span>                    
                    </div>
